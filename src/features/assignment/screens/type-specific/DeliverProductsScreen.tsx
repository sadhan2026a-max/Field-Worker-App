...
const styles = StyleSheet.create({
  ...
  itemDescription: { ...typography.bodyMedium, marginBottom: 2 },
  itemMeta: { ...typography.caption, color: colors.textSecondary },
  itemPrice: { ...typography.bodyMedium, fontFamily: typography.h2.fontFamily },
  summaryCard: {
  ...
  summaryLabel: { ...typography.bodyMedium, color: palette.greenDark, fontWeight: 'bold' },
  summaryValue: { ...typography.h2, color: palette.greenDark },
});
